...
```bash
# Using npm
npm install @lygos/nestjs-better-auth

# Using yarn
yarn add @lygos/nestjs-better-auth

# Using pnpm
pnpm add @lygos/nestjs-better-auth

# Using bun
bun add @lygos/nestjs-better-auth
```
...
import { AuthModule } from "@lygos/nestjs-better-auth";
...
import { AuthGuard } from "@lygos/nestjs-better-auth";
...
import { AuthModule, AuthGuard } from "@lygos/nestjs-better-auth";
import { auth } from "./auth";
...
import { Session, UserSession } from "@lygos/nestjs-better-auth";
...
```ts title="app.controller.ts"
import { Controller, Get } from "@nestjs/common";
import { Public, Optional } from "@lygos/nestjs-better-auth";
...
import { BeforeHook, Hook, AuthHookContext } from "@lygos/nestjs-better-auth";
...
import { AuthGuard, AuthService } from "@lygos/nestjs-better-auth";
